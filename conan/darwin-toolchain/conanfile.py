...
class DarwinToolchainConan(ConanFile):
    ...
    def package_info(self):
        ...
        if self.options.enable_bitcode is None:
            ...
            self.conf_info.define("tools.apple:enable_bitcode", self.options.enable_bitcode)
        ...
        if self.options.enable_visibility is None:
            ...
            self.conf_info.define("tools.apple:enable_visibility", self.options.enable_visibility)
